...
const Sidebar = () => {
  ...
  return (
    <div className='flex flex-col md:gap-4 md:h-screen w-full md:bg-zinc-200 px-1 sm:px-4 sm:py-1'>
        ...
        <div className="flex flex-col md:h-full md:place-content-between ">
          <div className="mt-4 flex sm:flex-row md:flex-col gap-4 md:gap-2 place-self-center overflow-x-auto w-full">
            {
              arr.map((title)=> (
                <div className='my-2 hover:rounded-lg hover:bg-cyan-950 hover:text-white rounded-sm transition-all duration-300 ease-in-out'>
